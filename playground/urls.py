...
urlpatterns = [
    ...
    path('lost/profile/<int:person_id>/', views.lost_person_profile, name='lost_person_profile'),
    path('found/profile/<int:person_id>/', views.found_person_profile, name='found_person_profile'),
